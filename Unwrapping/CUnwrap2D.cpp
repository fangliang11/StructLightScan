...
yes_no CUnwrap2D::find_pivot(EDGE *left, EDGE *right, float *pivot_ptr)
{
	EDGE a, b, c, *p;
...
EDGE* CUnwrap2D::partition(EDGE *left, EDGE *right, float pivot)
{
	while (left <= right)
	{
...
void CUnwrap2D::quicker_sort(EDGE *left, EDGE *right)
{
	EDGE *p;
	float pivot;
...
void  CUnwrap2D::initialisePIXELs(float *wrapped_image,
...
float CUnwrap2D::wrap(float pixel_value)
{
...
int CUnwrap2D::find_wrap(float pixelL_value, float pixelR_value)
{
	float difference;
	int wrap_value;
...
void CUnwrap2D::extend_mask(unsigned char *input_mask,
	unsigned char *extended_mask,
	int image_width,
	int image_height,
	params_t *params)
...
void CUnwrap2D::calculate_reliability(float *wrappedImage,
	PIXELM *pixel,
	int image_width,
	int image_height,
	params_t *params)
...
void  CUnwrap2D::horizontalEDGEs(PIXELM *pixel,
	EDGE *edge,
	int image_width,
	int image_height,
	params_t *params)
...
void CUnwrap2D::verticalEDGEs(PIXELM *pixel,
	EDGE *edge,
	int image_width,
	int image_height,
	params_t *params)
...
void  CUnwrap2D::gatherPIXELs(EDGE *edge, params_t *params)
{
	int k;
	PIXELM *PIXEL1;
	PIXELM *PIXEL2;
...
//unwrap the image
void  CUnwrap2D::unwrapImage(PIXELM *pixel, int image_width, int image_height)
{
	int i;
...
void  CUnwrap2D::maskImage(PIXELM *pixel, unsigned char *input_mask, int image_width, int image_height)
{
...
//phase map.
void  CUnwrap2D::returnImage(PIXELM *pixel, float *unwrapped_image, int image_width, int image_height)
{
	int i;
	int image_size = image_width * image_height;
